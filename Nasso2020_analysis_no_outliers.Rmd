...
```{r all_plot, fig.cap = "EMG amplitude in response to cue and target. **Note**: 18 values are outside the plot."}
...
```{r cue_plot, fig.cap = "EMG amplitude in response to cue. **Note**: 9 values are outside the plot."}
...
```{r target_plot, fig.cap = "EMG amplitude in response to target. **Note**: 9 values are outside the plot."}
